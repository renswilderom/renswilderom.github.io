...
Within this context of "cultural endogenous" dynamics (Van Venrooij, 2015; Godart and Galunic, 2019; Sgourev, Aadland, and Formilan, 2023), we can ask: who is associated with such  different film styles that go in and out of fashion? Understanding this could offer valuable insights into how, for instance, filmmakers' network positions are shaped by these recurring style dynamics. Ultimately, it could deepen our understanding of how style evolution influences the film industry, and help us to better comprehend the constitutive effects of culture more generally.

To identify distinct styles in films, I employ BERTopic (Grootendorst, 2022) to cluster frequently co-occurring film keywords into topics. The main contribution of this blog post lies in Sections 3 and 4, where I build on the hierarchical cluster matrix generated by BERT to compute style clusters—groups of related topics—generate time series data for these clusters, and link them to the individuals involved in their production.
