...
* (i) In Search Google type: "conda install plotly" (or the name of any other package which you like to install). This first search result brings you to the Anaconda.org page where you find the commmand line for installing the Plotly package: ```conda install -c plotly plotly```.
